import{i as Y,a as I,S,b as Z,N as G,P as Q,K as ee,A as ge,R as fe,M as ve}from"./assets/vendor-6LYjMKHJ.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const c={successList:document.querySelector(".success-list"),successBtnForward:document.querySelector(".success-button-forward"),successBtnBack:document.querySelector(".success-button-back"),successAnimation:document.querySelector(".ajax-loader"),ctgsList:document.querySelector(".pets-ctgs-list"),petsList:document.querySelector(".pets-list"),petsLoadBtn:document.querySelector(".pets-load-btn"),petsLoader:document.querySelector(".pets-loader"),petsPagination:document.querySelector(".pets-pagination")},he=document.querySelector(".burger-btn"),$=document.querySelector(".mobile-menu");document.querySelector(".mobile-menu-btn");document.querySelector(".mobile-menu-container");const ye=document.querySelectorAll(".mobile-menu-nav-link, .mobile-menu-button"),te=document.querySelector(".mobile-burger-menu-top-line"),se=document.querySelector(".mobile-burger-menu-mid-line"),ae=document.querySelector(".mobile-burger-menu-bot-line"),we=document.querySelector(".header"),oe=e=>{e.key==="Escape"&&M()},Le=()=>{te.classList.toggle("top-line"),se.classList.toggle("mid-line"),ae.classList.toggle("bot-line")},ke=()=>{te.classList.remove("top-line"),se.classList.remove("mid-line"),ae.classList.remove("bot-line")},Se=()=>{document.body.style.overflow="hidden",document.addEventListener("keydown",oe),$.classList.toggle("is-open"),$.className!=="mobile-menu is-open"&&(document.body.style.overflow=""),Le()},M=()=>{document.body.style.overflow="",$.classList.remove("is-open"),document.removeEventListener("keydown",oe),ke()},Ee=e=>{e.target.closest(".mobile-menu-btn, .mobile-menu-nav-link, .mobile-menu-button")||M()},xe=e=>{e.target.closest(".header-logo, .burger-btn")||M()};he.addEventListener("click",Se);we.addEventListener("click",xe);$.addEventListener("click",Ee);ye.forEach(e=>{e.addEventListener("click",M)});window.addEventListener("resize",()=>{innerWidth>=1440&&(document.body.style.overflow="",$.classList.remove("is-open"),M())});const m="/project-10/",ie=()=>window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop",ne=()=>C==="mobile"||C==="tablet"?8:9;let q,r=1,x,C=ie(),y=ne();const B=()=>C==="mobile",re=e=>Y.show({message:`Error: ${e}`,position:"topRight",color:"red",close:!1});function D(){const e=Math.ceil(x/y);if(e<=1)return;let s="";if(s+=`<li>
  ...
  `}const $e=async e=>{const s=e.target.closest("button");if(!s)return;const t=Math.ceil(x/y);s.dataset.action==="prev"&&r>1&&(r-=1),s.dataset.action==="next"&&r<t&&(r+=1),s.dataset.page&&(r=+s.dataset.page);const i=c.petsList.getBoundingClientRect().top+window.pageYOffset-200;window.scrollTo({top:i,behavior:"smooth"}),z(),await P(r,q),D()};c.petsPagination.addEventListener("click",$e);const qe=async()=>await I("https://paw-hut.b.goit.study/api/categories"),Ce=e=>{e.unshift({name:"Всі"});const s=["Всі","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];return e.sort((t,i)=>s.indexOf(t.name)-s.indexOf(i.name)),e.map(t=>`<li class="pets-ctgs-item"><button class="pets-ctgs-btn" aria-pressed="false" data-id="${t._id}" type="button">${t.name}</button></li>`).join("")},Be=async()=>{try{const e=await qe();c.ctgsList.innerHTML=Ce(e.data);const s=document.querySelector(".pets-ctgs-btn");s.classList.add("active"),s.dataset.id="all",s.setAttribute("aria-pressed","true")}catch(e){re(e.message)}},Me=async(e,s)=>{const t={page:e,limit:y};return s&&(t.categoryId=s),await I("https://paw-hut.b.goit.study/api/animals",{params:t})},R=e=>e.map(s=>`<li class="pets-item" role="listitem" data-id="${s._id}" data-description="${s.description||""}" data-health="${s.healthStatus||""}" data-behavior="${s.behavior||""}">
...
</li>`).join(""),P=async(e,s)=>{try{Te();const t=await Me(e,s);Oe(),B()?c.petsList.insertAdjacentHTML("beforeend",R(t.data.animals)):c.petsList.innerHTML=R(t.data.animals),x=t.data.totalItems,c.petsList.querySelectorAll(".pets-item").forEach((o,n)=>{const l=t.data.animals[n];l&&(o.dataset.description=l.description||"",o.dataset.health=l.healthStatus||"",o.dataset.behavior=l.behavior||"")})}catch(t){re(t.message)}},ce=()=>c.petsList.innerHTML="",Pe=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(t=>{t.classList.remove("active"),t.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},Ae=async e=>{e.target.nodeName==="BUTTON"&&(W(),z(),Pe(e.target),q=e.target.dataset.id==="all"?void 0:e.target.dataset.id,r=1,ce(),await P(r,q),B()&&x>y?F():B()||D())};c.ctgsList.addEventListener("click",Ae);const Xe=async()=>{r++,await P(r,q),r*y>=x&&W()};c.petsLoadBtn.addEventListener("click",Xe);const W=()=>{c.petsLoadBtn.style.display="none"},F=()=>{c.petsLoadBtn.style.display="block"},Oe=()=>{c.petsLoader.style.display="none"},Te=()=>{c.petsLoader.style.display="block"},z=()=>{c.petsPagination.style.display="none"},Ie=()=>{const e=ie();e!==C&&(ce(),W(),z(),C=e,y=ne(),r=1,P(r,q),e==="mobile"&&r*y<x?F():e!=="mobile"&&D())};window.addEventListener("resize",Ie);const De=async()=>{await Be(),await P(r),B()&&x>y?F():B()||D()};De();function Ne(){return`
    ...
    <div class="details-modal-backdrop" data-details-modal-backdrop>
      <div class="details-modal" role="dialog" aria-modal="true" aria-labelledby="details-modal-title" aria-describedby="details-modal-description">
        ...
        </div>`).join("");document.querySelector(".about-swiper-wrapper").innerHTML=ze;const v=new Z(".about-mySwiper",{modules:[G,Q,ee],loop:!1,slidesPerView:1,spaceBetween:10,keyboard:{enabled:!0},pagination:{el:".about .swiper-pagination",clickable:!0},navigation:{nextEl:".about-swiper-button-next",prevEl:".about-swiper-button-prev"}});function de(){const e=document.querySelector(".about .swiper-pagination");window.innerWidth<768?(e.classList.remove("center"),e.classList.add("left")):(e.classList.remove("left"),e.classList.add("center"))}de();window.addEventListener("resize",de);const ue=()=>{v.isEnd?V.classList.add("about-btn-disabled"):V.classList.remove("about-btn-disabled"),v.isBeginning?K.classList.add("about-btn-disabled"):K.classList.remove("about-btn-disabled")};v.on("slideChange",ue);ue();const me=document.querySelector(".about");v.on("slideChangeTransitionStart",()=>{me&&(document.querySelectorAll(".about-id").forEach(e=>e.classList.remove("show")),document.querySelectorAll(".about-overlay").forEach(e=>e.classList.remove("fade-out")))});v.on("slideChangeTransitionEnd",()=>{const e=v.slides[v.activeIndex],s=e.querySelector(".about-id");s&&s.classList.add("show");const t=e.querySelector(".about-overlay");t&&t.classList.add("fade-out")});const He=new IntersectionObserver(e=>{e.forEach(s=>{if(s.isIntersecting){const t=v.slides[v.activeIndex],i=t.querySelector(".about-id"),o=t.querySelector(".about-overlay");i&&(i.classList.remove("show"),i.offsetWidth,i.classList.add("show")),o&&(o.classList.remove("fade-out"),o.offsetWidth,o.classList.add("fade-out"))}})},{threshold:.7});He.observe(me);document.addEventListener("DOMContentLoaded",()=>{new ge(".accordion-container",{duration:250,showMultiple:!1,collapse:!0,ariaEnabled:!0})});document.addEventListener("click",e=>{const s=e.target.closest(".ac-trigger");s&&setTimeout(()=>{window.innerWidth<375&&s.scrollIntoView({behavior:"smooth",block:"start"})},450)});const _e=document.querySelector(".faq-ajax-loader"),U=30;for(let e=0;e<U;e++){const s=document.createElement("div");s.classList.add("paw"),s.style.animationDelay=`${(U-e)*.25+5}s`;const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.classList.add("icon");const i=document.createElementNS("http://www.w3.org/2000/svg","use");i.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#paw"),t.appendChild(i),s.appendChild(t),_e.appendChild(s)}I.defaults.baseURL="https://paw-hut.b.goit.study";const Re=async()=>(await I.get("/api/feedbacks",{params:{limit:25,page:18}})).data;document.addEventListener("DOMContentLoaded",Ve);async function Ve(){try{const e=await Re();Ke(e.feedbacks),document.querySelectorAll(".rating").forEach(s=>{const t=s.dataset.score;new fe(s,{score:t,number:5,readOnly:!0,half:!0,starType:"img",starOn:`${m}icons/filled.svg`,starOff:`${m}icons/outline.svg`,starHalf:`${m}icons/half.svg`}).init()})}catch{Y.error({message:"Error",position:"center"})}}const Ke=e=>{const s=e.map(t=>`<li class="swiper-slide success-item">
