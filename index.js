  ...
  `}const ie=async e=>{const t=e.target.closest("button");if(!t)return;const s=Math.ceil(b/p);t.dataset.action==="prev"&&o>1&&(o-=1),t.dataset.action==="next"&&o<s&&(o+=1),t.dataset.page&&(o=+t.dataset.page);const n=l.petsList.getBoundingClientRect().top+window.pageYOffset-200;window.scrollTo({top:n,behavior:"smooth"}),q(),await w(o,f),k()};l.petsPagination.addEventListener("click",ie);const oe=async()=>await C("https://paw-hut.b.goit.study/api/categories"),ae=e=>{e.unshift({name:"Всі"});const t=["Всі","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];return e.sort((s,n)=>t.indexOf(s.name)-t.indexOf(n.name)),e.map(s=>`<li class="pets-ctgs-item"><button class="pets-ctgs-btn" aria-pressed="false" data-id="${s._id}" type="button">${s.name}</button></li>`).join("")},ne=async()=>{try{const e=await oe();l.ctgsList.innerHTML=ae(e.data);const t=document.querySelector(".pets-ctgs-btn");t.classList.add("active"),t.dataset.id="all",t.setAttribute("aria-pressed","true")}catch(e){H(e.message)}},re=async(e,t)=>{const s={page:e,limit:p};return t&&(s.categoryId=t),await C("https://paw-hut.b.goit.study/api/animals",{params:s})},x=e=>e.map(t=>`<li class="pets-item" role="listitem">
...
</li>`).join(""),w=async(e,t)=>{try{pe();const s=await re(e,t);ue(),v()?l.petsList.insertAdjacentHTML("beforeend",x(s.data.animals)):l.petsList.innerHTML=x(s.data.animals),b=s.data.totalItems,l.petsList.querySelectorAll(".pets-item").forEach((i,a)=>{const r=s.data.animals[a];r&&(i.dataset.description=r.description||"",i.dataset.health=r.healthStatus||"",i.dataset.behavior=r.behavior||"")})}catch(s){H(s.message)}},j=()=>l.petsList.innerHTML="",le=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(s=>{s.classList.remove("active"),s.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},ce=async e=>{e.target.nodeName==="BUTTON"&&($(),q(),le(e.target),f=e.target.dataset.id==="all"?void 0:e.target.dataset.id,o=1,j(),await w(o,f),v()&&b>p?E():v()||k())};l.ctgsList.addEventListener("click",ce);const de=async()=>{o++,await w(o,f),o*p>=b&&$()};l.petsLoadBtn.addEventListener("click",de);const $=()=>{l.petsLoadBtn.style.display="none"},E=()=>{l.petsLoadBtn.style.display="block"},ue=()=>{l.petsLoader.style.display="none"},pe=()=>{l.petsLoader.style.display="block"},q=()=>{l.petsPagination.style.display="none"},me=()=>{const e=O();e!==h&&(j(),$(),q(),h=e,p=W(),o=1,w(o,f),e==="mobile"&&o*p<b?E():e!=="mobile"&&k())};window.addEventListener("resize",me);const be=async()=>{await ne(),await w(o),v()&&b>p?E():v()||k()};be();function ge(e){return`
    <div class="details-modal-backdrop" data-details-modal-backdrop>
      <div class="details-modal" role="dialog" aria-modal="true" aria-labelledby="details-modal-title" aria-describedby="details-modal-description">
        ...
        </div>`).join("");document.querySelector(".about-swiper-wrapper").innerHTML=he;const u=new F(".about-mySwiper",{modules:[V,U,Y],loop:!1,slidesPerView:1,spaceBetween:10,keyboard:{enabled:!0},pagination:{el:".about .swiper-pagination",clickable:!0},navigation:{nextEl:".about-swiper-button-next",prevEl:".about-swiper-button-prev"}});function z(){const e=document.querySelector(".about .swiper-pagination");window.innerWidth<768?(e.classList.remove("center"),e.classList.add("left")):(e.classList.remove("left"),e.classList.add("center"))}z();window.addEventListener("resize",z);const D=()=>{u.isEnd?P.classList.add("about-btn-disabled"):P.classList.remove("about-btn-disabled"),u.isBeginning?M.classList.add("about-btn-disabled"):M.classList.remove("about-btn-disabled")};u.on("slideChange",D);D();const R=document.querySelector(".about");u.on("slideChangeTransitionStart",()=>{R&&(document.querySelectorAll(".about-id").forEach(e=>e.classList.remove("show")),document.querySelectorAll(".about-overlay").forEach(e=>e.classList.remove("fade-out")))});u.on("slideChangeTransitionEnd",()=>{const e=u.slides[u.activeIndex],t=e.querySelector(".about-id");t&&t.classList.add("show");const s=e.querySelector(".about-overlay");s&&s.classList.add("fade-out")});const ve=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){const s=u.slides[u.activeIndex],n=s.querySelector(".about-id"),i=s.querySelector(".about-overlay");n&&(n.classList.remove("show"),n.offsetWidth,n.classList.add("show")),i&&(i.classList.remove("fade-out"),i.offsetWidth,i.classList.add("fade-out"))}})},{threshold:.7});ve.observe(R);document.addEventListener("DOMContentLoaded",()=>{new _(".accordion-container",{duration:250,showMultiple:!1,collapse:!0,ariaEnabled:!0})});document.addEventListener("click",e=>{const t=e.target.closest(".ac-trigger");t&&setTimeout(()=>{window.innerWidth<375&&t.scrollIntoView({behavior:"smooth",block:"start"})},450)});
