import{i as K,a as B,S as F,N as V,P as U,K as Y,A as _}from"./assets/vendor-DAtLxqiX.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const r={ctgsList:document.querySelector(".pets-ctgs-list"),petsList:document.querySelector(".pets-list"),petsLoadBtn:document.querySelector(".pets-load-btn"),petsLoader:document.querySelector(".pets-loader"),petsPagination:document.querySelector(".pets-pagination")},G=document.querySelector(".burger-btn"),g=document.querySelector(".mobile-menu");document.querySelector(".mobile-menu-btn");document.querySelector(".mobile-menu-container");const J=document.querySelectorAll(".mobile-menu-nav-link, .mobile-menu-button"),C=document.querySelector(".mobile-burger-menu-top-line"),A=document.querySelector(".mobile-burger-menu-mid-line"),T=document.querySelector(".mobile-burger-menu-bot-line"),Q=document.querySelector(".header"),I=e=>{e.key==="Escape"&&y()},X=()=>{C.classList.toggle("top-line"),A.classList.toggle("mid-line"),T.classList.toggle("bot-line")},Z=()=>{C.classList.remove("top-line"),A.classList.remove("mid-line"),T.classList.remove("bot-line")},ee=()=>{document.body.style.overflow="hidden",document.addEventListener("keydown",I),g.classList.toggle("is-open"),g.className!=="mobile-menu is-open"&&(document.body.style.overflow=""),X()},y=()=>{document.body.style.overflow="",g.classList.remove("is-open"),document.removeEventListener("keydown",I),Z()},te=e=>{e.target.closest(".mobile-menu-btn, .mobile-menu-nav-link, .mobile-menu-button")||y()},se=e=>{e.target.closest(".header-logo, .burger-btn")||y()};G.addEventListener("click",ee);Q.addEventListener("click",se);g.addEventListener("click",te);J.forEach(e=>{e.addEventListener("click",y)});window.addEventListener("resize",()=>{innerWidth>=1440&&(document.body.style.overflow="",g.classList.remove("is-open"),y())});const O=()=>window.innerWidth<768?"mobile":window.innerWidth<1440?"tablet":"desktop",W=()=>h==="mobile"||h==="tablet"?8:9;let f,a=1,b,h=O(),u=W();const v=()=>h==="mobile",H=e=>K.show({message:`Error: ${e}`,position:"topRight",color:"red",close:!1});function k(){const e=Math.ceil(b/u);if(e<=1)return;let t="";if(t+=`<li>
  ...
  `}const ie=async e=>{const t=e.target.closest("button");if(!t)return;const s=Math.ceil(b/u);t.dataset.action==="prev"&&a>1&&(a-=1),t.dataset.action==="next"&&a<s&&(a+=1),t.dataset.page&&(a=+t.dataset.page);const o=r.petsList.getBoundingClientRect().top+window.pageYOffset-200;window.scrollTo({top:o,behavior:"smooth"}),q(),await w(a,f),k()};r.petsPagination.addEventListener("click",ie);const oe=async()=>await B("https://paw-hut.b.goit.study/api/categories"),ae=e=>{e.unshift({name:"Всі"});const t=["Всі","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];return e.sort((s,o)=>t.indexOf(s.name)-t.indexOf(o.name)),e.map(s=>`<li class="pets-ctgs-item"><button class="pets-ctgs-btn" aria-pressed="false" data-id="${s._id}" type="button">${s.name}</button></li>`).join("")},ne=async()=>{try{const e=await oe();r.ctgsList.innerHTML=ae(e.data);const t=document.querySelector(".pets-ctgs-btn");t.classList.add("active"),t.dataset.id="all",t.setAttribute("aria-pressed","true")}catch(e){H(e.message)}},re=async(e,t)=>{const s={page:e,limit:u};return t&&(s.categoryId=t),await B("https://paw-hut.b.goit.study/api/animals",{params:s})},x=e=>e.map(t=>`<li class="pets-item" role="listitem">
...
</li>`).join(""),w=async(e,t)=>{try{pe();const s=await re(e,t);ue(),v()?r.petsList.insertAdjacentHTML("beforeend",x(s.data.animals)):r.petsList.innerHTML=x(s.data.animals),b=s.data.totalItems,r.petsList.querySelectorAll(".pets-item").forEach((i,n)=>{const l=s.data.animals[n];i.dataset.description=l.description||"",i.dataset.health=l.healthStatus||"",i.dataset.behavior=l.behavior||""})}catch(s){H(s.message)}},j=()=>r.petsList.innerHTML="",le=e=>{document.querySelectorAll(".pets-ctgs-btn").forEach(s=>{s.classList.remove("active"),s.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true")},ce=async e=>{e.target.nodeName==="BUTTON"&&(E(),q(),le(e.target),f=e.target.dataset.id==="all"?void 0:e.target.dataset.id,a=1,j(),await w(a,f),v()&&b>u?$():v()||k())};r.ctgsList.addEventListener("click",ce);const de=async()=>{a++,await w(a,f),a*u>=b&&E()};r.petsLoadBtn.addEventListener("click",de);const E=()=>{r.petsLoadBtn.style.display="none"},$=()=>{r.petsLoadBtn.style.display="block"},ue=()=>{r.petsLoader.style.display="none"},pe=()=>{r.petsLoader.style.display="block"},q=()=>{r.petsPagination.style.display="none"},me=()=>{const e=O();e!==h&&(j(),E(),q(),h=e,u=W(),a=1,w(a,f),e==="mobile"&&a*u<b?$():e!=="mobile"&&k())};window.addEventListener("resize",me);const be=async()=>{await ne(),await w(a),v()&&b>u?$():v()||k()};be();function ge(e){return`
    <div class="details-modal-backdrop" data-details-modal-backdrop>
      <div class="details-modal" role="dialog" aria-modal="true" aria-labelledby="details-modal-title" aria-describedby="details-modal-description">
        ...
        </div>`).join("");document.querySelector(".about-swiper-wrapper").innerHTML=he;const d=new F(".about-mySwiper",{modules:[V,U,Y],loop:!1,slidesPerView:1,spaceBetween:10,keyboard:{enabled:!0},pagination:{el:".about .swiper-pagination",clickable:!0},navigation:{nextEl:".about-swiper-button-next",prevEl:".about-swiper-button-prev"}});function R(){const e=document.querySelector(".about .swiper-pagination");window.innerWidth<768?(e.classList.remove("center"),e.classList.add("left")):(e.classList.remove("left"),e.classList.add("center"))}R();window.addEventListener("resize",R);const z=()=>{d.isEnd?P.classList.add("about-btn-disabled"):P.classList.remove("about-btn-disabled"),d.isBeginning?M.classList.add("about-btn-disabled"):M.classList.remove("about-btn-disabled")};d.on("slideChange",z);z();const D=document.querySelector(".about");d.on("slideChangeTransitionStart",()=>{D&&(document.querySelectorAll(".about-id").forEach(e=>e.classList.remove("show")),document.querySelectorAll(".about-overlay").forEach(e=>e.classList.remove("fade-out")))});d.on("slideChangeTransitionEnd",()=>{const e=d.slides[d.activeIndex],t=e.querySelector(".about-id");t&&t.classList.add("show");const s=e.querySelector(".about-overlay");s&&s.classList.add("fade-out")});const ve=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){const s=d.slides[d.activeIndex],o=s.querySelector(".about-id"),i=s.querySelector(".about-overlay");o&&(o.classList.remove("show"),o.offsetWidth,o.classList.add("show")),i&&(i.classList.remove("fade-out"),i.offsetWidth,i.classList.add("fade-out"))}})},{threshold:.7});ve.observe(D);document.addEventListener("DOMContentLoaded",()=>{new _(".accordion-container",{duration:250,showMultiple:!1,collapse:!0,ariaEnabled:!0})});document.addEventListener("click",e=>{const t=e.target.closest(".ac-trigger");t&&setTimeout(()=>{window.innerWidth<375&&t.scrollIntoView({behavior:"smooth",block:"start"})},450)});
